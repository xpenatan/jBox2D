...
group = "com.github.xpenatan.box2d.sample.android"
...
android {
    namespace = "com.github.xpenatan.box2d.sample.android"
    compileSdk = 36
...
tasks.register("box2d_samples_android_build") {
    group = "samples"
    description = "Builds the Box2D 3.1.1 Android sample browser."
    dependsOn("assembleDebug")
}

tasks.register<Exec>("box2d_samples_android_run") {
    group = "samples"
    ...
    val command = mutableListOf(adbExecutable(), "shell", "am", "start", "-n",
        "com.github.xpenatan.box2d.samples/com.github.xpenatan.box2d.sample.android.Box2DAndroidActivity")
