package com.github.xpenatan.box2d.sample.desktop;

import com.badlogic.gdx.backends.lwjgl3.Lwjgl3Application;
import com.badlogic.gdx.backends.lwjgl3.Lwjgl3ApplicationConfiguration;
import com.github.xpenatan.box2d.sample.Box2DSampleApplication;

public final class Box2DDesktopLauncher {
    private Box2DDesktopLauncher() {
    }

    public static void main(String[] args) {
        applyOptions(args);
        Lwjgl3ApplicationConfiguration config = new Lwjgl3ApplicationConfiguration();
        config.setTitle("jBox2D 3.1.1 Samples - JNI");
        config.setWindowedMode(1280, 720);
        config.useVsync(true);
        config.setForegroundFPS(60);
        new Lwjgl3Application(new Box2DSampleApplication(), config);
    }
