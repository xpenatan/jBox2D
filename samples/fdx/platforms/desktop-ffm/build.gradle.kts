...
registerDesktopSampleBuild("box2d_fdx_desktop_gl_${box2dRuntimeName}_build",
    "Builds the jBox2D libfdx desktop OpenGL sample with Box2D FFM.", glRuntimeClasspath)
registerDesktopSampleBuild("box2d_fdx_desktop_wgpu_${box2dRuntimeName}_build",
    "Builds the jBox2D libfdx desktop WGPU sample with Box2D FFM.", wgpuJniRuntimeClasspath)
registerDesktopSampleBuild("box2d_fdx_desktop_vulkan_${box2dRuntimeName}_build",
    "Builds the jBox2D libfdx desktop Vulkan sample with Box2D FFM.", vulkanRuntimeClasspath)

tasks.register<JavaExec>("box2d_fdx_desktop_gl_${box2dRuntimeName}_run") {
    configureSampleRun("Runs the jBox2D libfdx desktop OpenGL sample with Box2D FFM.",
...
tasks.register<JavaExec>("box2d_fdx_desktop_wgpu_${box2dRuntimeName}_run") {
    configureSampleRun("Runs the jBox2D libfdx desktop WGPU sample with Box2D FFM.",
...
tasks.register<JavaExec>("box2d_fdx_desktop_vulkan_${box2dRuntimeName}_run") {
    configureSampleRun("Runs the jBox2D libfdx desktop Vulkan sample with Box2D FFM.",
