...
public final class Box2DGdxSampleApplication extends ApplicationAdapter {
    ...
    public Box2DGdxSampleApplication() {
        this(parseLongProperty("jbox2d.sample.exitAfterFrames", 0L));
    }

    public Box2DGdxSampleApplication(long exitAfterFrames) {
    ...
    public void create() {
        ...
        controller = new Box2DSampleController(new Box2DSampleHost() {
            ...
            public void onSampleChanged(Box2DSampleEntry entry, Box2DSample sample) {
                if(drawRenderer == null) drawRenderer = new GdxSampleDrawRenderer();
