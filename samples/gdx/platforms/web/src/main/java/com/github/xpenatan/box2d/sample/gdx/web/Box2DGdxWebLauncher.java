package com.github.xpenatan.box2d.sample.gdx.web;
...
public final class Box2DGdxWebLauncher {
    private Box2DGdxWebLauncher() {
    }
    ...
    public static void main(String[] args) {
        ...
        config.useGL30 = true;
        new WebApplication(new Box2DGdxSampleApplication(), config);
    }
